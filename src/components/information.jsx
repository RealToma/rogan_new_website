...
export const Information = (props) => {
    return (
        <StyledContainer id='information'>
            <Box display="flex" width="60%" border="1px solid #14f195" flexDirection="column" alignItems="center" borderRadius="10px" height="100%">
                ...
                <Box display="flex" flex="0.6" width="100%" color="white" borderTop="1px solid #14f195">
                    ...
                    <Box display="flex" flex="1" flexDirection="column" borderLeft="1px solid #14f195">
                ...
                <Box display="flex" flex="0.5" width="100%" color="white" borderTop="1px solid #14f195" fontSize="1.5rem" fontWeight={"bold"} alignItems="center" justifyContent="center" >
